          ...
          element={
            <ProtectedRoute>
              <div className="h-full   flex items-start flex-col justify-start relative">
                <div className=" flex-shrink-0 w-full  items-center  justify-end flex view  bg-[#101011] h-[3.5rem] fixed z-10  ">
                  <div className="items-center h-full justify-end flex px-20">
                    <div className="w-fit h-full  flex-shrink-0 flex gap-4 items-center">
