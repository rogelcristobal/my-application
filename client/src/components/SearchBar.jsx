  ...
  return (
    <div className="max-w-[23rem] w-full relative bg-transparent">
      <input
        ...
        className={`input placeholder:font-inter input-ghost relative rounded-lg placeholder:text-[#a7a9ad]/70 w-full input-sm  placeholder:text-[0.8rem] h-[2.5rem] pl-11 max-w-sm focus:bg-white placeholder:font-normal focus:text-inherit  cursor cursor-pointer  focus:outline-none ${
