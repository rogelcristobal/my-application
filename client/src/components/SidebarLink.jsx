      ...
      {({ isActive }) => (
        <>
          <button
            ...
            className={`flex items-center gap-3 rounded-lg text-[0.775rem] text-left   ${
              isActive
                ? "text-white bg-[#292929]/70 "
                : "text-[#757575]/70 font-medium "
            } ${
              sidebarState ? " px-3 py-[0.65rem] justify-center" : " px-3 py-3"
            } flex-shrink-0   whitespace-nowrap  relative capitalize  mb-2.5 w-full`}
          >
          ...
          <div
            className={`w-full ${children ? "h-fit" : "h-0"} flex flex-col `}
          >
            {children}
          </div>
        </>
