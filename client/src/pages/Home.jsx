          ...
          <div className="flex items-center   px-6">
            <div className="flex flex-col items-start mb-5 w-full">
              <span className="text-[0.825rem] text-start capitalize text-[#d4d4d4]/40 font-normal">
                ...
                <p className="text-[1.55rem] text-[#d4d4d4]  mt-1.5 font-medium capitalize">
                  Welcome back!
                </p>
              </span>
            ...
            <div className=" flex gap-6 mt-1.5">
              {/* <div className="min-w-[16rem] h-fit px-[18px] py-[18px] flex-col flex justify-between rounded-lg bg-[#191b1f]">
                <div className="flex items-center  justify-start gap-1.5 ">
                  <span className="text-[0.8rem] font-normal text-[#d4d4d4]/40">
                    {" "}
                    Timed in at
                  </span>
                </div>
                <div className="mt-3 flex items-center gap-3.5">
                  <div className=" p-[0.5rem]  rounded-md view ">
                    {" "}
                    <PiClockBold className="text-[0.8rem] text-[#d4d4d4]/70 " />
                  </div>
