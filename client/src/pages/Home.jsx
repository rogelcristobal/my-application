...
import { LuHelpCircle, LuFile } from "react-icons/lu";
  ...
  return (
    <div className="h-full  container mx-auto w-full flex flex-col items-start justify-start relative">
      ...
      <div className="px-9 w-full  h-full pt-2">
        ...
        <div className=" px-4 py-3.5 thin-box-divider  rounded-lg mt-3 cursor-pointer items-center  flex  justify-start h-fit gap-4 w-60">
